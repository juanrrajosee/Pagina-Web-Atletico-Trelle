...
// Texto e icono de burbuja de sesión (opcional)
    ...
    <nav>
        <ul>
            ...
            <?php else: ?>
                ...
                <li><a class="<?= $activePage === 'historia' ? 'activo' : '' ?>" href="historia.php">Historia y Directiva</a></li>
                <li><a class="<?= $activePage === 'haztesocio' ? 'activo' : '' ?>" href="haztesocio.php">Hazte Socio</a></li>
